...
class login_args(object):
  ...
  def write(self, oprot):
    ...
    if self.loginProperties is not None:
      ...
      for kiter107,viter108 in list(self.loginProperties.items()):
...
class cloneTable_args(object):
  ...
  def write(self, oprot):
    ...
    if self.propertiesToSet is not None:
      ...
      for kiter143,viter144 in list(self.propertiesToSet.items()):
...
class getLocalityGroups_result(object):
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter166,viter167 in list(self.success.items()):
...
class listConstraints_result(object):
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter222,viter223 in list(self.success.items()):
...
class setLocalityGroups_args(object):
  ...
  def write(self, oprot):
    ...
    if self.groups is not None:
      ...
      for kiter244,viter245 in list(self.groups.items()):
...
class getSiteConfiguration_result(object):
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.MAP, 0)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
      for kiter284,viter285 in list(self.success.items()):
...
class getSystemConfiguration_result(object):
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.MAP, 0)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
      for kiter293,viter294 in list(self.success.items()):
...
class authenticateUser_args(object):
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      for kiter309,viter310 in list(self.properties.items()):
...
class updateAndFlush_args(object):
  ...
  def write(self, oprot):
    ...
    if self.cells is not None:
      ...
      for kiter345,viter346 in list(self.cells.items()):
...
class update_args(object):
  ...
  def write(self, oprot):
    ...
    if self.cells is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.cells))
      for kiter361,viter362 in list(self.cells.items()):
